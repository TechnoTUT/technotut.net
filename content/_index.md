---
banner:
  title: 豊橋技術科学大学 音楽技術部
  content: Music & Live production Club - TechnoTUT
  image: /images/index/top.jpg
  button:
    label: "Contact Us"
    link: "/contact"
...
services:
  ...
  - title: "DJ: Disc Jockey"
    ...
    images:
      ...
      - "/images/index/DJ/dj-1.JPG"
      - "/images/index/DJ/dj-3.jpg"
    button:
      enable: false
      label: Check!
      link: /about/dj
  ...
  - title: "DTM: 楽曲制作"
    ...
    images:
      ...
      - "/images/index/DTM/image2.jpg"
      - "/images/index/DTM/image6.jpg"
    button:
      enable: true
      label: Check it out
  ...
  - title: "TECH & DIY"
    ...
    images:
      ...
      - "/images/index/tech/stat.jpg"
      - "/images/index/tech/esp32.jpg"
      - "/images/index/tech/hikari.jpg"
      - "/images/index/tech/server.jpg"
      - "/images/index/tech/tran.jpg"
      - "/images/index/tech/switch4.jpg"
    button:
      enable: true
      label: Check!!
...
call_to_action:
  title: Ready to join?
  content: 豊橋技術科学大学 音楽技術部はいつでも部員を募集しています！ 気軽に部室に遊びに来てください！入部方法や活動詳細はこちら！<br/>TechnoTUT is always looking for new members! Feel free to come to our room anytime! For more information, please check here!
  image: '/images/index/DJ/dj-3.jpg'
  button:
    enable: true
    label: "Activity"
    link: "/activity"
